    ...
    >
        ...
        <div className="flex items-center gap-3 ml-13 pl-1">
          ...
          <motion.div
            ...
            className={`flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-semibold border ${
              isOnline
                ? "bg-emerald-50 text-emerald-700 border-emerald-200 dark:bg-blue-900/20 dark:text-emerald-400 dark:border-emerald-800"
      ...
      <div className="flex items-center gap-2">
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.97 }}
          onClick={onScanOpen}
          className="flex items-center gap-2 px-4 py-2.5 rounded-lg bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 text-sm font-semibold hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors"
        >
          <Scan className="w-4 h-4 hidden sm:block " />
          Scan
        </motion.button>
        ...
        <motion.div
          ...
          className="flex items-center gap-2 px-4 py-2.5 rounded-lg bg-blue-600 text-white text-sm font-bold shadow-sm"
        >
