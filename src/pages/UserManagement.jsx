    ...
    <div className="space-y-6 animate-fade-up">
      ...
      {showAddUser && (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4" onClick={() => { setShowAddUser(false); setEditingUser(null); }}>
          ...
          <div className="relative z-[10000] w-full max-w-md max-h-[90vh] flex flex-col overflow-hidden bg-white dark:bg-[#0d1f14] rounded-2xl shadow-2xl border border-slate-200/80 dark:border-emerald-900/20 animate-scale-in" onClick={e => e.stopPropagation()}>
      ...
      {showPermissions && selectedUser && (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4" onClick={() => setShowPermissions(false)}>
          <div className="absolute inset-0 bg-black/60 backdrop-blur-sm" />
          <div className="relative z-[10000] w-full max-w-2xl max-h-[90vh] flex flex-col overflow-hidden bg-white dark:bg-[#0d1f14] rounded-2xl shadow-2xl border border-slate-200/80 dark:border-emerald-900/20 animate-scale-in" onClick={e => e.stopPropagation()}>
            <div className="px-6 py-5 border-b border-slate-100 dark:border-emerald-900/15 flex items-center justify-between">
              <div>
              ...
              <button onClick={() => setShowPermissions(false)} className="p-2 hover:bg-slate-100 dark:hover:bg-[#122b1c] rounded-xl text-slate-500 transition-colors"><X className="w-4 h-4" /></button>
            </div>
            <div className="px-6 py-3 border-b border-slate-100 dark:border-emerald-900/15 flex gap-2">
