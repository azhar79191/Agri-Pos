...
import { getProducts, createProduct, updateProduct, deleteProduct, getLowStockProducts } from "../api/productApi";
...
export const useProductStore = create(
  persist(
    ...
    { name: "pos-products", partialize: (s) => ({ products: s.products, brands: s.brands }) }
  )
);
