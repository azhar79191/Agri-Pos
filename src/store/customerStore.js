...
import {
  ...
  deleteCustomer, updateCustomerCredit, depositCredit,
...
export const useCustomerStore = create((set) => ({
  ...
  fetchCustomers: async (params) => {
    ...
    try {
      ...
      set({
        customers: Array.isArray(data) ? data : data?.customers ?? data?.docs ?? [],
        loading: false,
      });
      return res.data;
    } catch (err) {
  ...
  // Optimistic credit deduction after a credit sale
